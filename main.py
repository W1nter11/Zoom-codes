...
lessons = ["Ілля", "Фізика", "Математикаа", "Технології", "Інгліш", "Укр.мова,літ", "Хімія", "Біологія", "Інформатика","LSE"]
two_group_teachers = ["1. Наталія Вадимовна ","2. Ірина Олеговна ","1. Інна ","2. ЛІля ","1. Тетяна Ткачова ","2. Дар'я Євгенівна "]
